        ...
        <div className="max-w-[99%] md:max-w-4xl mx-auto bg-gray-800 p-6 md:p-10 rounded-lg shadow-lg">
          ...
          <div className="space-y-4">
            ...
            <div>
              ...
              <p className="text-gray-300 mt-2">Если в турнире победят 5 из 10 команд, эти пять команд сразятся друг с другом. Победитель не имеет значения, всё определяется случайным образом. 3 команды с наибольшим количеством побед выбывают, турнир завершается, а победители получают свои призы.</p>
            </div>
            ...
            <div>
              ...
              <p className="text-gray-300 mt-2">Победители получат призовые деньги в течение 24 часов после окончания турнира.</p>
            </div>
          </div>
        </div>
      </div>
