        ...
        <div className="max-w-[99%] md:max-w-4xl mx-auto bg-gray-800 p-6 md:p-10 rounded-lg shadow-lg">
          ...
          <div className="space-y-4">
            ...
            <div>
              ...
              <p className="text-gray-300 mt-2">Если в турнире победят 6 из 12 команд, эти 10 команд команд сразятся друг с другом. Победитель не имеет значения, всё определяется случайным образом. 3 команды с наибольшим количеством побед выбывают, турнир завершается, а победители получают свои призы.</p>
            </div>
            ...
            <div>
              <h2 className="text-xl sm:text-2xl font-semibold text-red-500">4. Призовой фонд и выплаты</h2>
              <p className="text-gray-300 mt-2">Победители получат призовые деньги в течение 2 часов после окончания турнира.</p>
            </div>
          </div>
        </div>
      </div>
