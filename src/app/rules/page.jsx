    ...
    return (
      ...
      <div className="min-h-screen text-white p-6 md:p-12">
        <div className="max-w-4xl mx-auto bg-gray-800 p-6 md:p-10 rounded-lg shadow-lg">
          <h1 className="text-3xl md:text-4xl font-bold text-yellow-400 mb-6 text-center">SevenStrike Tournament Rules</h1>
          
          <div className="space-y-4">
            <div>
              <h2 className="text-2xl font-semibold text-red-500">1. General Rules</h2>
            ...
            <div>
              <h2 className="text-2xl font-semibold text-red-500">5. Server Settings</h2>
              <p className="text-gray-300 mt-2">All matches will be played on 128-tick servers with VAC enabled.</p>
            </div>
            
            <div>
              <h2 className="text-2xl font-semibold text-red-500">6. Prize Pool & Payouts</h2>
